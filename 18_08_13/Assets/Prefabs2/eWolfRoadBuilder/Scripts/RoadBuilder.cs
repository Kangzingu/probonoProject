...
namespace eWolfRoadBuilder
{
    ...
    public class RoadBuilder : MonoBehaviour, IRoadBuildData, IMaterialFrequency
    {
        ...
        public List<int> GetTriangles(string materialName)
        {
            ...
            {
                materialName = MaterialFrequency.FrequencyRateMaterial(Details, MaterialFrequency.FrequencyRate.UnderRoadTexture);
            ...
            if (string.IsNullOrEmpty(materialName))
            {
                ...
                {
                    materialName = MaterialFrequency.FrequencyRateMaterial(Details, MaterialFrequency.FrequencyRate.MainTexture);
                }
            }
