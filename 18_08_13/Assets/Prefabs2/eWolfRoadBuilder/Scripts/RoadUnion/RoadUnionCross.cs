...
{
    /// <summary>
    /// Cross Road Union class
    /// </summary>
    public class RoadUnionCross : IRoadUnion
    {
        /// <summary>
        /// Constructor
        /// </summary>
        /// <param name="node">The node</param>
        public RoadUnionCross(RoadNetworkNode node)
        {
        ...
        public void CreateLayout(RoadBuilder roadBuilderObject)
        {
            ...
            CreateCrossRoads(roadBuilderObject, _roadNetworkNode.Details.Sections);
        }
        ...
        {
            CreateCrossRoadsTerrain(_roadNetworkNode.Details.Sections, tm);
        }
        ...
        private void CreateCrossRoads(RoadBuilder roadObject, int sections)
        {
            ...
            _meshSection.AddCrossRoad(connectionSet, _roadNetworkNode, RoadConstructorHelper.GetMainMaterial(materialFrequency));
