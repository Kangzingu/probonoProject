...
namespace eWolfRoadBuilder.Terrains
{
    ...
    public class TerrainModifier : MonoBehaviour
    {
        ...
        public Vector3 GetPos(Vector3 pos)
        {
            ...
            pos.x *= _terrainData.heightmapWidth;
            pos.z *= _terrainData.heightmapHeight;
        ...
        private void SetHeight(int x, int y, float newHeight, bool isPlateau)
        {
            ...
            {
                Debug.Log("SetHeight has failed with X:" + x + " Y:" + y);
            }
        }
        ...
        private float GetTerrainHeight(Vector3 pos)
        {
            ...
            {
                Debug.Log("GetTerrainHeight has failed with X:" + x + " Y:" + y);
                return 0;
            }
        }
