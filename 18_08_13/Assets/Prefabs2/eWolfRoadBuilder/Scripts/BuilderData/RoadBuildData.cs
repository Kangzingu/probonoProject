...
namespace eWolfRoadBuilder
{
    public class RoadBuildData : IRoadBuildData
    {
        ...
        {
            if (materialName == MaterialFrequency.UnderRoadMaterial)
            {
                materialName = MaterialFrequency.FrequencyRateMaterial(RoadConstructorHelper.MaterialFrequencySet.GetDetails, MaterialFrequency.FrequencyRate.UnderRoadTexture);
                if (string.IsNullOrEmpty(materialName))
                {
                    Debug.LogError("Can't find a Under Road material - please add one to use the Under road options.");
                }
            }
            ...
            if (string.IsNullOrEmpty(materialName))
            {
                ...
                {
                    materialName = MaterialFrequency.FrequencyRateMaterial(RoadConstructorHelper.MaterialFrequencySet.GetDetails, MaterialFrequency.FrequencyRate.MainTexture);
                }
            }
