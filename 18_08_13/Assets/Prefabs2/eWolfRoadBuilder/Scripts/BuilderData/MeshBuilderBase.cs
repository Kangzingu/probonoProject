...
namespace eWolfRoadBuilder
{
    ...
    public abstract class MeshBuilderBase
    {
        ...
        protected void DrawQuad(Vector3 a, Vector3 b, Vector3 c, Vector3 d, Vector2 uva, Vector2 uvb, Vector2 uvc, Vector2 uvd, string materialName = null)
        {
            ...
            _roadObject.GetTriangles(materialName).AddRange(new int[] { v + 2, v + 1, v });
            _roadObject.GetTriangles(materialName).AddRange(new int[] { v + 1, v + 2, v + 3 });
        ...
        /// <param name="uvc">UV Point C</param>
        /// <param name="materialName">The material to use</param>
        protected void DrawTri(Vector3 a, Vector3 b, Vector3 c, Vector2 uva, Vector2 uvb, Vector2 uvc, string materialName = null)
        {
            if (string.IsNullOrEmpty(materialName))
            {
                materialName = _materialName;
